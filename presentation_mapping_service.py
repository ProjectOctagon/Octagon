...
class PresentationMappingService:
    ...
    def _create_slides_for_boxes(self, org_id, org_name, manager, boxes):
        ...
        box_chunks = self._split_into_chunks(boxes, chunk_size=21)
        ...
        for index, chunk in enumerate(box_chunks):
            ...
            columns = self._split_into_columns(chunk, max_items_per_column=7)
    ...
    def _split_into_columns(self, items, max_items_per_column=7):
        columns = []
    ...
    def _split_into_chunks(self, items, chunk_size=14):
        chunks = []
